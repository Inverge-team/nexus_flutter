...
class NexusLogs {
  ...
  void trace(String message, {String? source, Map<String, Object?>? context}) =>
      _log('trace', message, source, context);
  void debug(String message, {String? source, Map<String, Object?>? context}) =>
      _log('debug', message, source, context);
  void info(String message, {String? source, Map<String, Object?>? context}) =>
      _log('info', message, source, context);
  void warn(String message, {String? source, Map<String, Object?>? context}) =>
      _log('warn', message, source, context);
  void error(String message, {String? source, Map<String, Object?>? context}) =>
      _log('error', message, source, context);
